...
INSERT INTO contenido (titulo, descripcion, formato, tipo , evento, aparece, url, plataforma, thumbnail) VALUES ('Aragón Open Data', 'Ponencia ofrecida en los cursos formativos ofrecidos a los empleados del Gobierno de Aragón, dentro de unas jornadas sobre transparencia y participación pública. Descripción de las principales tareas, objetivos y servicios de Aragón Open Data', 3, 6 , 30, 'José Mª Subero', 'http://es.slideshare.net/aragonopendata/el-nuevo-marco-normativo-de-la-transparencia-y-la-participacin-ciudadana-en-aragn', 5, 'http://cdn.slidesharecdn.com/ss_thumbnails/marconormativotransparenciaopendata-160307135909-thumbnail.jpg?cb=1457359423');
INSERT INTO contenido (titulo, descripcion, formato, tipo , evento, aparece, url, plataforma, thumbnail) VALUES ('Aragón Open Data initiative at the Open Data Global Leaders'' Network of the Open Data Institute', 'Exposición del recorrido de la iniciativa Aragón Open Data desde su creación como catálogo de conjunto de datos, pasando por su posterior etapa como prestador servicios y su enfoque como futura plataforma global del Gobierno de Aragón', 4, 6 , 29, 'José Mª Subero', 'https://www.youtube.com/watch?v=REWTxpIXZSM', 7, 'http://img.youtube.com/vi/REWTxpIXZSM/1.jpg');
